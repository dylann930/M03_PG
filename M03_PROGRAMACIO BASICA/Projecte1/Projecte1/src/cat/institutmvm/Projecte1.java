...
public class Projecte1 {
    ...
    public static final String MSG_1 = "Introduzca el ID del cliente.";
    public static final String MSG_2 = "El ID introducido es: ";
    public static final String MSG_3 = "Introduzca la edad del cliente.";
    public static final String MSG_4 = "TIPO DE VENTA.";
    public static final String MSG_5 = "Venta libre (0)";
    public static final String MSG_6 = "Pensionista (1)";
    public static final String MSG_7 = "Carnet Joven (2)";
    public static final String MSG_8 = "Socio (3)";
    public static final String MSG_9 = "Programa finalizado por error en los datos. Tiene 3 intentos para ingresar cada dato.";
    public static final String MSG_10 = "Introduzca el importe total de la compra.";
    public static final String MSG_11 = "Introduzca el número de teléfono del cliente.";
    public static final String MSG_12 = "La edad introducida es: ";
    public static final String MSG_13 = "El tipo de venta introducida es el número: ";
    public static final String MSG_14 = "El importe total introducido es: ";
    public static final String MSG_15 = "El número de teléfono introducido es: ";
    public static final String MSG_16 = "Indique el número de tipo de venta a continuación: ";
